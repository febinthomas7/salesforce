...
const ReportUpload = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const patientId = "0015f00000"; // Replace with actual patient Salesforce Id
    const doctorId = "a015f00000"; // Replace with actual doctor Salesforce Id
    const hospitalId = "a025f000"; // Replace with actual hospital Salesforce Id

    try {
      // 1️⃣ Build multipart form data
      const formPayload = new FormData();
      formPayload.append("file", uploadedFile);
      formPayload.append("patientId", patientId); // Salesforce Patient Id
      formPayload.append("doctorId", doctorId); // Salesforce Doctor Id
      formPayload.append("hospitalId", hospitalId); // Salesforce Hospital Id
      ...
      // 3️⃣ Optional UI preview (same as before)
      const newReport = {
